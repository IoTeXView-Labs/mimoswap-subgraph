...
export class MimoV2Router02__addLiquidityResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class MimoV2Router02__removeLiquidityResult {
  value0: BigInt;
  value1: BigInt;
...
export class MimoV2Router02__removeLiquidityETHResult {
  value0: BigInt;
  value1: BigInt;
...
export class MimoV2Router02 extends ethereum.SmartContract {
  static bind(address: Address): MimoV2Router02 {
    return new MimoV2Router02("MimoV2Router02", address);
  }
  ...
  addLiquidity(
    ...
    deadline: BigInt,
    referrer: Address
  ): MimoV2Router02__addLiquidityResult {
    let result = super.call(
      "addLiquidity",
      "addLiquidity(address,address,uint256,uint256,uint256,uint256,address,uint256,address):(uint256,uint256,uint256)",
      [
    ...
    return new MimoV2Router02__addLiquidityResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_addLiquidity(
    ...
    deadline: BigInt,
    referrer: Address
  ): ethereum.CallResult<MimoV2Router02__addLiquidityResult> {
    ...
    return ethereum.CallResult.fromValue(
      new MimoV2Router02__addLiquidityResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
  ...
  removeLiquidity(
    ...
    deadline: BigInt,
    referrer: Address
  ): MimoV2Router02__removeLiquidityResult {
    let result = super.call(
      "removeLiquidity",
      "removeLiquidity(address,address,uint256,uint256,uint256,address,uint256,address):(uint256,uint256)",
      [
        ethereum.Value.fromAddress(tokenA),
        ethereum.Value.fromAddress(tokenB),
    ...
    return new MimoV2Router02__removeLiquidityResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_removeLiquidity(
    ...
    deadline: BigInt,
    referrer: Address
  ): ethereum.CallResult<MimoV2Router02__removeLiquidityResult> {
    let result = super.tryCall(
      "removeLiquidity",
      "removeLiquidity(address,address,uint256,uint256,uint256,address,uint256,address):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new MimoV2Router02__removeLiquidityResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  removeLiquidityETH(
    ...
    deadline: BigInt,
    referrer: Address
  ): MimoV2Router02__removeLiquidityETHResult {
    let result = super.call(
      "removeLiquidityETH",
      "removeLiquidityETH(address,uint256,uint256,uint256,address,uint256,address):(uint256,uint256)",
      [
    ...
    return new MimoV2Router02__removeLiquidityETHResult(
      result[0].toBigInt(),
      result[1].toBigInt()
    );
  }
  ...
  try_removeLiquidityETH(
    ...
    deadline: BigInt,
    referrer: Address
  ): ethereum.CallResult<MimoV2Router02__removeLiquidityETHResult> {
    let result = super.tryCall(
      "removeLiquidityETH",
      "removeLiquidityETH(address,uint256,uint256,uint256,address,uint256,address):(uint256,uint256)",
      [
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new MimoV2Router02__removeLiquidityETHResult(
        value[0].toBigInt(),
        value[1].toBigInt()
      )
    );
  ...
  removeLiquidityETHSupportingFeeOnTransferTokens(
    ...
    let result = super.call(
      "removeLiquidityETHSupportingFeeOnTransferTokens",
      "removeLiquidityETHSupportingFeeOnTransferTokens(address,uint256,uint256,uint256,address,uint256,address):(uint256)",
      [
        ethereum.Value.fromAddress(token),
        ethereum.Value.fromUnsignedBigInt(liquidity),
        ethereum.Value.fromUnsignedBigInt(amountTokenMin),
  ...
  swapExactTokensForETH(
    ...
    let result = super.call(
      "swapExactTokensForETH",
      "swapExactTokensForETH(uint256,uint256,address[],address,uint256,address):(uint256[])",
      [
        ethereum.Value.fromUnsignedBigInt(amountIn),
  ...
  swapExactTokensForTokens(
    ...
    let result = super.call(
      "swapExactTokensForTokens",
      "swapExactTokensForTokens(uint256,uint256,address[],address,uint256,address):(uint256[])",
      [
        ethereum.Value.fromUnsignedBigInt(amountIn),
        ethereum.Value.fromUnsignedBigInt(amountOutMin),
        ethereum.Value.fromAddressArray(path),
  ...
  swapTokensForExactETH(
    ...
    let result = super.call(
      "swapTokensForExactETH",
      "swapTokensForExactETH(uint256,uint256,address[],address,uint256,address):(uint256[])",
      [
        ethereum.Value.fromUnsignedBigInt(amountOut),
  ...
  swapTokensForExactTokens(
    ...
    let result = super.call(
      "swapTokensForExactTokens",
      "swapTokensForExactTokens(uint256,uint256,address[],address,uint256,address):(uint256[])",
      [
        ethereum.Value.fromUnsignedBigInt(amountOut),
        ethereum.Value.fromUnsignedBigInt(amountInMax),
        ethereum.Value.fromAddressArray(path),
