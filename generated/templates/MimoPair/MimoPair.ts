...
export class MimoPair__burnResult {
  value0: BigInt;
  value1: BigInt;
...
export class MimoPair__getReservesResult {
  value0: BigInt;
  value1: BigInt;
  value2: BigInt;
...
export class MimoPair extends ethereum.SmartContract {
  static bind(address: Address): MimoPair {
    return new MimoPair("MimoPair", address);
  }
  ...
  burn(to: Address): MimoPair__burnResult {
    let result = super.call("burn", "burn(address):(uint256,uint256)", [
      ethereum.Value.fromAddress(to)
    ]);

    return new MimoPair__burnResult(result[0].toBigInt(), result[1].toBigInt());
  }

  try_burn(to: Address): ethereum.CallResult<MimoPair__burnResult> {
    ...
    return ethereum.CallResult.fromValue(
      new MimoPair__burnResult(value[0].toBigInt(), value[1].toBigInt())
    );
  }
  ...
  getReserves(): MimoPair__getReservesResult {
    let result = super.call(
      "getReserves",
    ...
    return new MimoPair__getReservesResult(
      result[0].toBigInt(),
      result[1].toBigInt(),
      result[2].toBigInt()
    );
  ...
  try_getReserves(): ethereum.CallResult<MimoPair__getReservesResult> {
    let result = super.tryCall(
      "getReserves",
      "getReserves():(uint112,uint112,uint32)",
      []
    ...
    let value = result.value;
    return ethereum.CallResult.fromValue(
      new MimoPair__getReservesResult(
        value[0].toBigInt(),
        value[1].toBigInt(),
        value[2].toBigInt()
      )
